...
func init() {
	...
	configCmd.PersistentFlags().StringVarP(&image, "image", "i", "quay.io/leandroberetta/mimik", "Image tag name")
	configCmd.PersistentFlags().StringVarP(&version, "version", "v", "v0.0.2", "Image version")

...
func init() {
	...
	serverCmd.PersistentFlags().StringVarP(&image, "image", "i", "quay.io/leandroberetta/topogen", "Image tag name")
	serverCmd.PersistentFlags().StringVarP(&version, "version", "v", ReleaseVersion, "Image version")

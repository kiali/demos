...
cd travel_control
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../docker/travel_control/travel_control
...
cd travel_portal
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../docker/travel_portal/travel_portal
cd ..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/cars/cars
cd ../..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/discounts/discounts
cd ../..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/flights/flights
cd ../..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/hotels/hotels
cd ../..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/insurances/insurances
cd ../..
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o ../../docker/travel_agency/travels/travels
cd ../..
